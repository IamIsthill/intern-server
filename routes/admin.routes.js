...
import { adminFindController, getAllAccounts, getRequestingInterns, approveIntern } from '../controllers/admin.controller.js'
...
adminRouter.put('/accounts/intern-request', validateAccess('admin'), approveIntern)
